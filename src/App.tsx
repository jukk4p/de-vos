  ...
  return (
    <Router>
      ...
      <main className="relative min-h-screen bg-background text-white selection:bg-accent selection:text-background overflow-hidden">
        ...
        <Routes>
          <Route path="/" element={<HomePage openWhatsApp={openWhatsApp} />} />
        ...
        {/* FAB WhatsApp - Industrial Edition */}
        <button 
          onClick={openWhatsApp}
          className="fixed bottom-10 right-10 z-50 bg-accent text-background p-5 rounded-none shadow-[0_0_50px_rgba(233,195,73,0.3)] hover:bg-white transition-smooth flex items-center justify-center border border-accent hover:border-white accent-glow group"
