      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-20 mb-24">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <button 
            ...
            className="mt-8 px-8 border border-white/10 text-white font-black text-[10px] uppercase tracking-industrial py-4 hover:bg-accent hover:text-background hover:border-accent transition-smooth w-full md:w-auto"
          >
